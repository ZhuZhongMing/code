...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		/*filterChainDefinitionMap.put("/system/gsTemperature/**", "anon");
		filterChainDefinitionMap.put("/system/gsMaterial/**", "anon");
		filterChainDefinitionMap.put("/system/gsProcess/**", "anon");
		filterChainDefinitionMap.put("/system/gsReactionCell/**", "anon");*/
